...
class ListService {
    ...
    private func addDummyData() {
        ...
        let newGame = Game(state: .ended, dateStarted: Date(), dateEnded: Date(), totalTime: 178, playerTop: Player(color: .white, name: "Tom"), playerBottom: Player(color: .black, name: "Johannes"), winner: Player(color: .white, name: "Tom"), loser: Player(color: .black, name: "Johannes"), timeWinner: Player(color: .black, name: "Johannes"), settings: nil)
